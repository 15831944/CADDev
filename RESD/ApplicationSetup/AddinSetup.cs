...
namespace eZcad.RESD
{
    ...
    public class AddinSetup : IExtensionApplication
    {
        ...
        private const string CmdStartRibbon = SQConstants.eZGroupCommnad + @"Ribbon";
        /// <summary> 添加自定义功能区选项卡 </summary>
        [CommandMethod(SQConstants.eZGroupCommnad, CmdStartRibbon, SQConstants.ModelState)]
        public void CreateRibbon()
        {
            AutoCAD.AcadApplication acadApplication = Autodesk.AutoCAD.ApplicationServices.Application.AcadApplication as AutoCAD.AcadApplication;
            ...
            {
                SQUtils.SendCommandSync("Ribbon ");
        ...
        private static void AddControls(RibbonTab ribTab)
        {
            ...
            AddButton(spltBtn2, method: typeof(InfosGetter_Substitution).GetMethod(InfosGetter_Substitution.CommandName, new Type[0]), size: RibbonItemSize.Large);
            ...
            AddButton(pnl_Tools, method: typeof(BlockRefEditor).GetMethod(BlockRefEditor.CommandName, new Type[0]), size: RibbonItemSize.Large);
