...
namespace eZcad.Addins
{
    ...
    public class BlockRefEditor : ICADExCommand
    {
        ...
        , RibbonItem(CommandText, CommandDescription, SQConstants.ImageDirectory + "EditBlockRefText_32.png")]
            ...
            ref IList<ObjectId> elementSet)
        {
            ...
            return SQAddinManagerDebuger.DebugInAddinManager(s.EditBlockRef,
