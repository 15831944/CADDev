...
namespace eZcadDebuger.Addins
{
    ...
    public class RoadStationRS
    {
        ...
        [CommandMethod(AddinOptions.GroupCommnad, "GetRoadStation1", CommandFlags.Modal | CommandFlags.UsePickSet)]
        ...
        private void PickBaseStation(Curve c)
        {
            ...
            {
                basePt = eZcad.Utility.Utils.GetPointFromString(res.StringResult);
            }
