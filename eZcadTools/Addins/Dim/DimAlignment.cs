...
using Constants = eZcadTools.Utility.Constants;
...
namespace eZcadTools.Addins.Dim
{
    /// <summary> 标注对象的对齐 </summary>
    [EcDescription(CommandDescription)]
    internal class DimAlignment : ICADExCommand
    {
            ...
            ref IList<ObjectId> elementSet)
        {
            ...
            return AddinManagerDebuger.DebugInAddinManager(s.AlignDim,
