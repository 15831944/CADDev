...
namespace eZcadTools.Addins
{
    ...
    public class EcLoadTemplate1
    {
        ...
        [CommandMethod(AddinOptions.GroupCommnad, "EcInstanceMethod1", CommandFlags.Modal)]
        ...
        [CommandMethod(AddinOptions.GroupCommnad, "EcInstanceMethod2", CommandFlags.Modal)]
        ...
        [CommandMethod(AddinOptions.GroupCommnad, "EcStaticeMethod1", CommandFlags.Modal)]
