...
using AddinSetup = eZcadTools.AppSetup.AddinSetup;
...
namespace eZcadTools.AppSetup
{
    ...
    internal class AddinSetup : IExtensionApplication
    {
        ...
        /// <summary> 选项卡中每个工具按钮的图标文件所在文件夹 </summary>
        ...
        [CommandMethod(AddinOptions.GroupCommnad, CmdStartRibbon, Constants.ModelState)]
        ...
        private static void AddControls(RibbonTab ribTab)
        {
            ...
            AddButton(pnl_Project, method: typeof(SelSetIntersector).GetMethod(SelSetIntersector.CommandName, new Type[0]), size: RibbonItemSize.Large);
            AddButton(pnl_Project, method: typeof(ViewportCreator).GetMethod(ViewportCreator.CommandName, new Type[0]), size: RibbonItemSize.Large);
