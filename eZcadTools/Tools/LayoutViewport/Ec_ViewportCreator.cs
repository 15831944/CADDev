...
using eZcadTools.Examples;
using eZcadTools.Utility;
using AddinOptions = eZcadTools.AppSetup.AddinOptions;

[assembly: CommandClass(typeof(ViewportCreator))]

namespace eZcadTools.Addins.LayoutViewport
{
    ...
    public class ViewportCreator : ICADExCommand
    {
        ...
        /// <summary> 命令行命令名称，同时亦作为命令语句所对应的C#代码中的函数的名称 </summary>
        private const string CommandText = @"创建视口";
            ...
            ref IList<ObjectId> elementSet)
        {
            ...
            return AddinManagerDebuger.DebugInAddinManager(s.CreateViewport,
